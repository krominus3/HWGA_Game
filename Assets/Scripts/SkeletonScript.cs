...
public class EnemyStateMachine : MonoBehaviour
{
    ...
    public void TakeDamage(int damage)
    {
        ...
        //animator.SetTrigger("hit"); // «апускаем анимацию получени€ урона
    ...
    {
        // ≈сли столкновение со снар€дом
        if (collision.gameObject.CompareTag("Projectile"))
        {
            TakeDamage(1); // ¬раг получает урон
            Destroy(collision.gameObject); // ”ничтожаем снар€д после попадани€
        }
    }
